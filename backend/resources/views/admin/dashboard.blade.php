                    ...
                    <div class="widget  t-sales-widget">
                        <div class="media">
                            ...
                            <div class="media-body text-right">
                                ...
                                <p class="widget-numeric-value">1</p>
                            </div>
                        </div>
                        <p class="widget-total-stats mt-2">11 active mails</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 mb-xl-0 col-lg-6 mb-4 col-md-6 col-sm-6">
                <div class="widget-content-area  data-widgets br-4">
                    <div class="widget  t-order-widget">
                        ...
                        <p class="widget-total-stats mt-2">11 active jobs</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget  t-customer-widget">
                        <div class="media">
                            ...
                            <div class="media-body text-right">
                                ...
                                <p class="widget-numeric-value">2</p>
                            </div>
                        </div>
                        <p class="widget-total-stats mt-2">2 active news</p>
                    </div>
                </div>
            </div>
