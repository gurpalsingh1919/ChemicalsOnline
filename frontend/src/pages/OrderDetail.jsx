				...
				<div className="row">
					...
					<div className="col-lg-12">
						<div className="orderItemsDetail mt-5">
							<h2 className="">Items Details</h2>
							<div className="shoppingCartProducts checkoutCart">
								<div className="cart-row mt-2">
									<div className="row">
										<div className="col-md-8 col-sm-8">
											<div className="d-flex">
												<div className="productImage"><img src="/images/products/tote_360x.jpg" alt="" className="imgResponsive" /></div>
												<Link href="#" className="productName ms-2">ETHANOL 190 PRF CANE 270 GL</Link>
											</div>
										</div>
								...
								<div className="cart-row">
									<div className="row">
										<div className="col-md-8 col-sm-8">
											<div className="d-flex">
												<div className="productImage"><img src="/images/products/blue-drum_360x.jpg" alt="" className="imgResponsive" /></div>
												<Link href="#" className="productName ms-2">ETHANOL 190 PRF CANE 270 GL</Link>
											</div>
										</div>
										<div className="col-md-4 col-sm-4">
