			...
			<div className="row">
				<div className="col-md-12">
					...
					<div className="faq">
						...
						<p>If you are an existing customer, our Customer Service team can provide you with your User ID and Password. If you are a new customer, you can apply to set up an account with us by <a href="/register" rel="nofollow" target="_self" className="text-blue">clicking here</a>. Our Customer Service team can be reached at 1-800-243-5360 or <a href="mailto:customer.service@greenfield.com" target="_blank" className="text-blue">customer.service@greenfield.com</a>.</p>
						...
						<p>Click <a href="#" rel="" target="_blank" className="text-blue">HERE</a> for our terms and conditions.</p>
					</div>
				</div>
			</div>
		</div>
